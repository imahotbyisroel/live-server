...
if( ! class_exists( 'EF3MegaMenuFramework' ) ) {
	...
	class EF3MegaMenuFramework {
		...
		function __construct() {
			...
			if(!isset($spcharityplus_theme_options['spcharityplus_enable_mega_menu']) || !$spcharityplus_theme_options['spcharityplus_enable_mega_menu'])
				return;
...
add_action('init', 'spcharityplus_mega_menu', 5);

function spcharityplus_mega_menu(){
